...
class HM
{
    ...
    public function run()
    {
        ...
        define("HM_CONFIG",$this->config);
        defined("APP_PATH") or define("APP_PATH",$this->config['app_path']);
        $router=(new \hm\lib\Router())->getRoute();
        ...
        $common_file= HM_BASEPATH . APP_PATH ."/".M."/common/common.php";
        include $common_file;
        $file= HM_BASEPATH . APP_PATH ."/".M."/controller/".ucfirst(C).".php";
        if(is_file($file)){
            ...
            if(defined("M") && defined("C") && defined("A")){
                if(method_exists($controller,"assign")){
